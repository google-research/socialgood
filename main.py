...
def index():
    ...
    # Display it using a simple html template
    return render_template('index_template.html', dropdown=country_dropdown, json_str=json_str, selected_country=selected_country)
